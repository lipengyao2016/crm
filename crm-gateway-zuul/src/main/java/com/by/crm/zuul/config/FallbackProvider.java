package com.by.crm.zuul.config;
	...
	public ClientHttpResponse fallbackResponse() {
		return new ClientHttpResponse() {
			...
			public InputStream getBody() throws IOException {
				...
				restful.setCode(1010);
				restful.setMessage("当前服务不可用，请稍后再试或联系系统管理员。");
				return new ByteArrayInputStream(JSONObject.toJSONString(restful).getBytes());
			}
